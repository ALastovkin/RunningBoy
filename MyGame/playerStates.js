...
export class Running extends State{
    ...
    enter(){
        this.game.player.frameY = 0;
        this.game.player.frameX = 0;
        this.game.player.maxFrame = 41;
        /**/this.game.player.width = 100;
    }
    handleInput(input){
...
export class Jumping extends State{
    ...
    enter(){
        ...
        this.game.player.maxFrame = 21;
        /**/this.game.player.width = 83;
    }
    handleInput(input){
...
export class Hit extends State{
    ...
    handleInput(input){
        if (this.game.player.frameX >= 41 && this.game.player.onGround()){
            this.game.player.setState(states.RUNNING, 1);
        } else if (this.game.player.frameX >= 41 && !this.game.player.onGround()){
            this.game.player.setState(states.FALLING, 1);
        }
    }
}